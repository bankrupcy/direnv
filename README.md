...
1. direnv is packaged in most distributions already. See [the installation
documentation](docs/installation.md) for more details.
2. hook direnv into your shell. Follow the [hook installation
   documentation](docs/hook.md).

Now restart your shell.

### Quick demo

To follow along in your shell.
